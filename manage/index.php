...
?>
<a href="./userserch.php"><button class="btn btn-primary btn-block">ユ　ー　ザ　検　索</button></a><br>
<a href="./negoaccept.php"><button class="btn btn-secondary btn-block">交　渉　履　歴　承　認</button></a><br>
<?php
if(authority($_SESSION['uid'])=="root"){
    echo '<a href="./negoaccept.php"><button class="btn btn-success btn-block">ロ　グ　検　索</button></a><br>';
}
?>
</div>

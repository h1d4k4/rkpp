...
?>
<a href="contract/index.php"><button class="btn btn-primary btn-block">契　約　検　索</button></a><br>
<a href="record/index.php"><button class="btn btn-secondary btn-block">契　約　新　規　登　録</button></a><br>
</div>
